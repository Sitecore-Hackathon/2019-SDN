...
namespace Hackathon.SDN.Feature.TranslationRibbon {
    ...
    public class TranslationPanel : RibbonPanel {
        ...
        public override void Render(HtmlTextWriter output, Ribbon ribbon, Item button, CommandContext context) {
            ...
            sb.Append($"<p style=\"padding-top: 6px; padding-bottom: 6px;\">{Translate.Text("TranslationRibbon_SelectTargetLanguage")}</p>");
            ...
            sb.Append("<a id=\"deepl-button\" href=\"#\" class=\"scRibbonToolbarLargeComboButtonTop\" title=\"" + Translate.Text("TranslationRibbon_StartTranslation") + "\" onclick=\"(function() { let lang = document.getElementById(\'translation-languages\').value;return scForm.invoke(\'Command:TranslateContent(language=\'+ lang + \', include_sub_items=0)\', event);})();\">");
            ...
            sb.Append($"<span class=\"header\">{Translate.Text("TranslationRibbon_StartTranslation")}</span><img src=\"/sitecore/shell/themes/standard/Images/ribbondropdown.gif\" class=\"scRibbonToolbarLargeComboButtonGlyph\" alt=\"\" border=\"0\" />");
            ...
            sb.Append($"<td class=\"scMenuItemCaption\">{Translate.Text("TranslationRibbon_TranslateItemIncludingSubItems")}</td>");
